...
import 'package:evently/features/auth/login/presentation/cubit/login_state.dart';
      ...
      listener: (context, state) {
        if (state.status == LoginStatus.success) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(state.message ?? AppStrings.fbLoginSuccess)),
          );
        }
        ...
        if (state.status == LoginStatus.error) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(state.message ?? AppStrings.fbLoginErrorMsg),
            ),
          );
        }
      },
